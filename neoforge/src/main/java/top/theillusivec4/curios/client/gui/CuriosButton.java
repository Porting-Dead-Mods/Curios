...
public class CuriosButton extends ImageButton {
  ...
  public static final WidgetSprites BIG =
      new WidgetSprites(ResourceLocation.withDefaultNamespace("button"),
              ResourceLocation.withDefaultNamespace("button_highlighted"));
  public static final WidgetSprites SMALL =
      new WidgetSprites(ResourceLocation.withDefaultNamespace("button_small"),
              ResourceLocation.withDefaultNamespace("button_small_highlighted"));

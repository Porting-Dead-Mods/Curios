...
public class CuriosCapability {
  ...
  public static final ResourceLocation ID_INVENTORY = ResourceLocation.withDefaultNamespace("inventory");
  public static final ResourceLocation ID_ITEM_HANDLER = ResourceLocation.withDefaultNamespace("item_handler");
  public static final ResourceLocation ID_ITEM = ResourceLocation.withDefaultNamespace("item");
